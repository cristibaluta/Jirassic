...
class JLPredictiveTimeTyping: NSObject {
	...
	NSDateComponents* comps = [gregorian components:(NSCalendarUnitHour|NSCalendarUnitMinute|NSCalendarUnitSecond)
	fromDate:[NSDate date]];
	
	NSArray *hm = [text componentsSeparatedByString:@":"];
	...
	comps.hour = ([hm count] == 1) ? [hm[0] intValue] : 19;
	comps.minute = 0;
	}
