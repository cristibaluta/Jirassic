...
extension SQLiteMigrator {
    ...
    func migrate (db: SQLiteDB, toVersion version: SQLiteSchemaVersion) {
        ...
        case .v1_0:
            ...
            let _ = db.execute(sql: "CREATE TABLE IF NOT EXISTS stasks (lastModifiedDate DATETIME, deleted BOOL DEFAULT 0, startDate DATETIME, endDate DATETIME, notes TEXT, taskNumber TEXT, taskType INTEGER NOT NULL, objectId varchar(100) PRIMARY KEY);")
